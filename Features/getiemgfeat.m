%
% getIEMGfeat: gets the Integrated EMG feature.
% == Integrated Absolute Value (IAV)
% 
% feat = getiemgfeat(x,winsize,wininc,[])
%
% This function computes the integrated EMG feature of the signals in x,
...
%
% Outputs
%    feat:     integrated EMG value in a 2 dimensional matrix
%              dim1 window
%              dim2 feature (col i is the features for the signal in column i of x)

function feat = getiemgfeat(x,winsize,wininc,option) %#ok<INUSD>
