%
% getRMSfeat: Gets the Root Mean Square feature.
% Root mean square == v-Order 2
%
% feat = getrmsfeat(x,winsize,wininc,[])
%
% This function computes the root mean square feature of the signals in x,
...
%
% Outputs
%    feat:     root mean square value in a 2 dimensional matrix
%              dim1 window
%              dim2 feature (col i is the features for the signal in column i of x)

function feat = getrmsfeat(x,winsize,wininc,option) %#ok<INUSD>
